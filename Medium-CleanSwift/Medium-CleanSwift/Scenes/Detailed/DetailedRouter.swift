...
class DetailedRouter: NSObject, DetailedRoutingLogic, DetailedDataPassing {
    ...
    //func navigateToSomewhere(source: DetailedViewController, destination: SomewhereViewController)
    //{
    ...
    //func passDataToSomewhere(source: DetailedDataStore, destination: inout SomewhereDataStore)
    //{
